    ...
    <VerticalSpacing unit={10}>
      ...
      <Slat>
        <VerticalSpacing unit={3}>
          ...
          <Regular>Free parking can also be found on Station Road for up to one hour.</Regular>
          ...
          <Regular>The entrance straight into the clinic is on Cheltenham Lane, just off Cheltenham Road. To get to this entrance, walk along Cheltenham Lane (opposite Brookfield Road), turn right and follow the lane. You will see the sign for the Enso Healing Rooms. Simply ring the door bell and someone will let you in and show you to the waiting area. </Regular>

          <Regular>Alternatively, you can access Enso Healing Rooms through the Enso Martial Arts shop. The shop is open between 10am till 6pm Monday to Friday and 10am till 5pm on Saturdays. You can use this entrance whenever the shop is open and someone will show you where to go.</Regular>
