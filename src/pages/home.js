    ...
    <VerticalSpacing unit={10}>
      <Slat>
        <VerticalSpacing unit={3}>
          ...
          <Regular>If you&#39;d like to find out more about what I can offer, you can read more <Link to="/about">about me here</Link>, read about the <Link to="/about#what">types of counselling I offer</Link> here or <Link to="/contact">Contact me</Link></Regular>
        </VerticalSpacing>
      </Slat>
    </VerticalSpacing>
  )
