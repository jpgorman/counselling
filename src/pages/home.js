...
import {Regular, VerticalSpacing, Slat} from "../components"
    ...
    <VerticalSpacing unit={10}>
      <Slat>
        <VerticalSpacing unit={3}>
          <img src={`/${theme.assets.headShot}`} width="100%" />
          ...
          <Regular>If you&#39;d like to find out more about what I can offer, you can read more <Link to="/about">about me here</Link>, read about the <Link to="/counselling">types of counselling I offer</Link> here or <Link to="/contact">Contact me</Link></Regular>
        </VerticalSpacing>
      </Slat>
    </VerticalSpacing>
  )
