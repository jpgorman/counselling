...
import {Header, Regular, VerticalSpacing} from "../components"
  ...
  return (
    <VerticalSpacing unit={10}>
      <VerticalSpacing unit={3}>
        ...
        <Regular>If you&#39;d like to find out more about what I can offer, you can read more about me (Link to about me) here, read about the types of therapy I offer here (link to What will therapy be like?) or Contact me (link to contact)</Regular>
      </VerticalSpacing>
    </VerticalSpacing>
  )
}
